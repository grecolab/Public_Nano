...
source("/home/MOKA/laura/NanoSolveIT_data_preprocessing/src/Illumina_functions.R")
source("/home/MOKA/laura/NanoSolveIT_data_preprocessing/src/pipeline_functions.R")
library(swamp)
library(WriteXLS)
